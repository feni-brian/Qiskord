...
const roleIconMap = { GUEST: null, MODERATOR: <ShieldCheck className="h-4 w-4 ml-2 text-indigo-500" />, ADMIN: <ShieldAlert className="h-4 w-4 text-rose-500" /> };
...
export const MembersModal = () => {
	...
	const onDismiss = async (memberId: string) => {
		try {
								...
								<div className="ml-auto">
									<DropdownMenu>
										...
										<DropdownMenuContent side="left">
											...
											<DropdownMenuSeparator />
											<DropdownMenuItem onClick={() => onDismiss(member.id)}>
