...
export const InviteServerModal = () => {
	...
	const inviteUrl = `${origin}/invite/${server?.invite}`;
	const onCopy = () => {
			...
			<DialogContent className="bg-white text-black p-0 overflow-hidden">
				...
				<div className="p-6">
					...
					<div className="flex items-center mt-2 gap-x-2">
						<Input value={inviteUrl} disabled={isLoading} className="bg-zinc-300/50 border-0 focus-visible:ring-0 text-black focus-visible:ring-offset-0" />
