...
export const MediaRoom = ({ chatId, video, audio, params }: MediaRoomProps) => {
	...
	return (
		<LiveKitRoom data-lk-theme="default" token={token} connect={true} video={video} audio={audio} serverUrl={process.env.NEXT_PUBLIC_LIVEKIT_URL} onDisconnected={redirectToGeneral}>
			<VideoConference />
		</LiveKitRoom>
	);
};
